...
module.exports = {
  ...
  REGEX_MONGODATASERVICES_CLASS_UNTIL_CONSTRUCTOR: /implements IDataServices, OnApplicationBootstrap\s*\{([\s\S]*?)constructor\(/,
  REGEX_MONGODATASERVICES_CONSTRUCTOR_PARAMETERS: /constructor\(([\s\S]*?)\)\s*\{/,
